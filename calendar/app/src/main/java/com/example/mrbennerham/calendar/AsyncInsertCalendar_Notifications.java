...
//        String a = date+t+timer;
        ...
        DateTime endDateTime = new DateTime(drugsmorningtimeend+":00+07:00");
    ...
    public void Drugs_noon() throws IOException {
        ...
        String date = name.getdate();
        String timer = name.gettimernoon();
        String t = "T";
//        String a = date+t+timer;
        ...
        DateTime endDateTime = new DateTime(drugsnoontimeend+":00+07:00");
        EventDateTime end = new EventDateTime()
                .setDateTime(endDateTime)
                .setTimeZone("Asia/Bangkok");
        Add_Drung.setEnd(end);
    ...
    public void Drugs_evening() throws IOException {
        ...
        String date = name.getdate();
        String timer = name.gettimerevening();
        String t = "T";
//        String a = date+t+timer;
        ...
        DateTime endDateTime = new DateTime(drugsevengtimeend+":00+07:00");
        EventDateTime end = new EventDateTime()
                .setDateTime(endDateTime)
                .setTimeZone("Asia/Bangkok");
        Add_Drung.setEnd(end);
    ...
    public void Drugs_before() throws IOException {
        ...
        String date = name.getdate();
        String timer = name.gettimerbefore();
        String t = "T";
//        String a = date+t+timer;
        ...
        DateTime endDateTime = new DateTime(drugsbeforetimeend+":00+07:00");
        EventDateTime end = new EventDateTime()
                .setDateTime(endDateTime)
                .setTimeZone("Asia/Bangkok");
        Add_Drung.setEnd(end);
